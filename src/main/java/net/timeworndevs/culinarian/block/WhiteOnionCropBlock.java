...
public class WhiteOnionCropBlock extends PlantBlock implements Fertilizable {
    public static final int MAX_AGE = 7;
    public static final IntProperty AGE;
    private static final VoxelShape[] AGE_TO_SHAPE;

    public WhiteOnionCropBlock(Settings settings) {
        super(settings);
    }
    ...
    protected ItemConvertible getBulbItem() {
        return CommonItemRegistry.WHITE_ONION_BULB;
    }

    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(this.getBulbItem());
    }
