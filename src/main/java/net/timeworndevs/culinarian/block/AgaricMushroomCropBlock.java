...
public class AgaricMushroomCropBlock extends PlantBlock implements Fertilizable {
    public static final int MAX_AGE = 7;
    public static final IntProperty AGE;
    private static final VoxelShape[] AGE_TO_SHAPE;

    public AgaricMushroomCropBlock(Settings settings) {
        super(settings);
    }
    ...
    protected ItemConvertible getSporesItem() {
        return CommonItemRegistry.AGARIC_SPORES;
    }
