...
public class RedOnionCropBlock extends PlantBlock implements Fertilizable {
    public static final int MAX_AGE = 7;
    public static final IntProperty AGE;
    private static final VoxelShape[] AGE_TO_SHAPE;

    public RedOnionCropBlock(Settings settings) {
        super(settings);
    }
    ...
    protected ItemConvertible getBulbItem() {
        return CommonItemRegistry.RED_ONION_BULB;
    }
