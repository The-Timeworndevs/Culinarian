...
public class CulinarianItems {
    ...
    public static final Item GRILLED_PORTABELLO = registerItem("grilled_portabello", properties -> new Item(properties.food(CulinarianConsumables.GRILLED_PORTABELLO_FOOD)));
