...
public class ChoppingBlockScreenHandler extends ScreenHandler {
    ...
    public ChoppingBlockScreenHandler(int syncId, PlayerInventory playerInventory) {
    ...
    public ChoppingBlockScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        ...
        this.input = new SimpleInventory(1) {
            public void markDirty() {
                super.markDirty();
                ChoppingBlockScreenHandler.this.onContentChanged(this);
                ChoppingBlockScreenHandler.this.contentsChangedListener.run();
            }
        };
        ...
        this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                ChoppingBlockScreenHandler.this.output.unlockLastRecipe(player, this.getInputStacks());
                ItemStack itemStack = ChoppingBlockScreenHandler.this.inputSlot.takeStack(1);
                if (!itemStack.isEmpty()) {
                    ChoppingBlockScreenHandler.this.populateResult();
                }
            ...
            private List<ItemStack> getInputStacks() {
                return List.of(ChoppingBlockScreenHandler.this.inputSlot.getStack());
            }
        });
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(CommonRecipeRegistry.CHOPPING, input, this.world);
        }
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (slot2 != null && slot2.hasStack()) {
            ...
            } else if (this.world.getRecipeManager().getFirstMatch(CommonRecipeRegistry.CHOPPING, new SimpleInventory(new ItemStack[]{itemStack2}), this.world).isPresent()) {
